  ...
  <div class="min-h-screen bg-black text-white font-sans">
    ...
    <div class="relative h-screen flex flex-col justify-center items-center overflow-hidden bg-gradient-to-b from-black to-gray-900">
      ...
      <div class="z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div class="flex justify-center mb-8">
          <div class="relative">
            <div class="absolute inset-0 blur-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-70 scale-150"></div>
        ...
        <h1 class="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 mb-6 tracking-wide leading-tight transform -rotate-1">LAST SONGS</h1>

        <!-- Enhanced divider with animation -->
        <div class="relative h-2 max-w-md mx-auto mb-8 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 border-2 border-white transform rotate-1"></div>
    ...
    <div id="main-content" class="max-w-6xl mx-auto p-4 md:p-8">
      ...
      <div class="mb-4 text-center space-x-4">
        ...
        <button @click="showUserProfile = !showUserProfile" class="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white font-bold py-2 px-4 rounded-full mb-4 inline-flex items-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8 bg-black border-4 border-white shadow-[12px_12px_0px_0px_rgba(255,255,255,0.2)] p-8">
        <div class="flex flex-col">
          ...
          <div class="relative">
            <input id="username" v-model="username" type="text" placeholder="Enter your Last.fm username" class="w-full p-3 bg-gray-900 border-4 border-white text-base text-white placeholder-gray-500 focus:ring-0 focus:outline-none focus:border-purple-400 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)]" />
        ...
        <div class="flex flex-col">
          ...
          <div class="relative">
            <select id="period" v-model="period" class="w-full appearance-none p-3 bg-gray-900 border-4 border-white text-base text-white focus:ring-0 focus:outline-none focus:border-teal-400 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.8)] pr-10">
        ...
        <div class="flex items-end">
          <button @click="fetchData" :disabled="isLoading" class="w-full p-3 bg-gradient-to-r from-purple-300 via-teal-300 to-blue-400 text-black font-black text-lg uppercase tracking-wide transform hover:translate-x-1 hover:translate-y-1 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)] border-4 border-black disabled:opacity-50 disabled:cursor-not-allowed transition-transform duration-200 flex items-center justify-center gap-2">
            <svg v-if="isLoading" class="animate-spin h-6 w-6 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div v-else-if="isLoading" class="text-center p-12 bg-black border-4 border-white shadow-[12px_12px_0px_0px_rgba(255,255,255,0.2)] mb-10">
        <div class="flex flex-col items-center">
          <div class="w-full max-w-md p-5 bg-gradient-to-r from-purple-300 via-teal-300 to-blue-400 text-black relative overflow-hidden min-h-[120px] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)] mb-8 transform rotate-[-1deg]">
          ...
          <div class="relative">
            ...
            <div class="animate-spin rounded-full h-16 w-16 border-8 border-white border-t-purple-500 mb-6"></div>
          </div>
      ...
      <footer class="text-center mt-16 pt-6 border-t-4 border-white text-white">
        <div class="flex justify-center items-center gap-6 mb-4">
          <span class="w-5 h-5 bg-purple-300 border-2 border-black transform rotate-[10deg]"></span>
          <span class="w-5 h-5 bg-teal-300 border-2 border-black"></span>
          <span class="w-5 h-5 bg-blue-400 border-2 border-black transform rotate-[-10deg]"></span>
        </div>
        <p class="font-bold mb-2">Powered by <a href="https://www.last.fm/api" target="_blank" class="text-purple-300 hover:underline hover:text-purple-400 transition-colors">Last.fm API</a> | Built with Vue 3, Pinia, and Tailwind CSS</p>
        <p class="font-bold">Made with <span class="text-red-500 text-xl relative top-0.5">❤️</span> by <a href="https://github.com/nachthirsch" target="_blank" class="text-purple-300 hover:underline hover:text-purple-400 transition-colors">yuunaagi</a></p>
      </footer>
    </div>
  </div>
</template>
